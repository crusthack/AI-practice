...
Submit overlapped socket IO and handle completion.

## Run / Build

`powershell
MSBuild 09_Implementation_IOModels\03_OverlappedIO\03_OverlappedIO.vcxproj /p:Configuration=Debug /p:Platform=x64
`
