...
Use select to watch multiple sockets for readiness.

## Run / Build

`powershell
MSBuild 09_Implementation_IOModels\01_Select_Model\01_Select_Model.vcxproj /p:Configuration=Debug /p:Platform=x64
`
