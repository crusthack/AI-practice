...
Compare Named Pipe IPC with socket-style communication.

## Run / Build

`powershell
MSBuild 10_Platform_WinNetAPI\03_NamedPipe_Net\03_NamedPipe_Net.vcxproj /p:Configuration=Debug /p:Platform=x64
`
