...
Create a fixed binary header plus variable payload protocol.

## Run / Build

`powershell
MSBuild 06_Framing_BinaryProtocol\01_Custom_Protocol\01_Custom_Protocol.vcxproj /p:Configuration=Debug /p:Platform=x64
`
