...
Implement TCP length-prefix framing and recvExact style reads.

## Run / Build

`powershell
MSBuild 06_Framing_BinaryProtocol\02_Layered_TCPFraming\02_Layered_TCPFraming.vcxproj /p:Configuration=Debug /p:Platform=x64
`
