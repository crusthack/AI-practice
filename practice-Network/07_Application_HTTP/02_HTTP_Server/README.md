...
Parse a simple HTTP request and generate a response.

## Run / Build

`powershell
MSBuild 07_Application_HTTP\02_HTTP_Server\02_HTTP_Server.vcxproj /p:Configuration=Debug /p:Platform=x64
`
