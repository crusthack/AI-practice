...
Send and receive UDP multicast through a joined group.

## Run / Build

`powershell
MSBuild 03_Network_Multicast\01_Multicast\01_Multicast.vcxproj /p:Configuration=Debug /p:Platform=x64
`
