...
Wrap TCP stream operations and prepare for application framing.

## Run / Build

`powershell
MSBuild 05_Transport_TCP\04_Layered_TcpSock\04_Layered_TcpSock.vcxproj /p:Configuration=Debug /p:Platform=x64
`
