...
Implement TCP server lifecycle: socket, bind, listen, accept, recv, send.

## Run / Build

`powershell
MSBuild 05_Transport_TCP\01_TCP_Server\01_TCP_Server.vcxproj /p:Configuration=Debug /p:Platform=x64
`
