...
Experiment with socket options such as timeout, keepalive, and TCP_NODELAY.

## Run / Build

`powershell
MSBuild 05_Transport_TCP\03_Socket_Options\03_Socket_Options.vcxproj /p:Configuration=Debug /p:Platform=x64
`
