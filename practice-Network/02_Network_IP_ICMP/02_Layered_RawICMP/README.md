...
Build and parse ICMP Echo Request/Reply fields.

## Run / Build

`powershell
MSBuild 02_Network_IP_ICMP\02_Layered_RawICMP\02_Layered_RawICMP.vcxproj /p:Configuration=Debug /p:Platform=x64
`
