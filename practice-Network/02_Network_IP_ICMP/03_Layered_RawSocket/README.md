...
Parse IPv4 payload as ICMP, TCP, or UDP based on protocol number.

## Run / Build

`powershell
MSBuild 02_Network_IP_ICMP\03_Layered_RawSocket\03_Layered_RawSocket.vcxproj /p:Configuration=Debug /p:Platform=x64
`
