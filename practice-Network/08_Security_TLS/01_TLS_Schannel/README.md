...
Use Schannel to create a TLS client and send HTTPS data.

## Run / Build

`powershell
MSBuild 08_Security_TLS\01_TLS_Schannel\01_TLS_Schannel.vcxproj /p:Configuration=Debug /p:Platform=x64
`
