...
Design a custom application protocol over UDP datagrams.

## Run / Build

`powershell
MSBuild 04_Transport_UDP\03_Layered_CustomUDP\03_Layered_CustomUDP.vcxproj /p:Configuration=Debug /p:Platform=x64
`
