...
Add custom UDP-like header, fragmentation, and reassembly over UDP.

## Run / Build

`powershell
MSBuild 04_Transport_UDP\02_Layered_UdpSock\02_Layered_UdpSock.vcxproj /p:Configuration=Debug /p:Platform=x64
`
