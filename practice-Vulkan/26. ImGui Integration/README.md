...
## Intent
Integrate Dear ImGui as a debug UI overlay for Vulkan samples.
...
## New Concepts
- ImGui context
- descriptor pool for UI
- frame UI build
- overlay draw data

## Expected Result
A 1280x720 Win32 window titled `26. ImGui Integration` opens, clears the swapchain image to this sample's documented color, and presents until closed.
