...
{
    const wchar_t* className = L"Vulkan13StagingAndDeviceLocalWindowClass";
...
void InitVulkan(VulkanContext& vk)
{
    ...
    appInfo.pApplicationName = "13. Staging And Device Local";
...
int WINAPI wWinMain(HINSTANCE instance, HINSTANCE, PWSTR, int showCommand)
{
    ...
    catch (const std::exception& ex)
    {
        ...
        MessageBoxW(nullptr, message.c_str(), L"13. Staging And Device Local Error", MB_OK | MB_ICONERROR);
        return -1;
    }
}
