...
{
    const wchar_t* className = L"Vulkan11FramesInFlightWindowClass";
...
void InitVulkan(VulkanContext& vk)
{
    ...
    appInfo.pApplicationName = "11. Frames In Flight";
...
int WINAPI wWinMain(HINSTANCE instance, HINSTANCE, PWSTR, int showCommand)
{
    ...
    catch (const std::exception& ex)
    {
        ...
        MessageBoxW(nullptr, message.c_str(), L"11. Frames In Flight Error", MB_OK | MB_ICONERROR);
        return -1;
    }
}
