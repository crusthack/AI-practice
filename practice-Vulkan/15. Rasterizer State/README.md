...
## Intent
Change polygon mode, culling, and front-face settings in pipeline state.
...
## Expected Result
A 1280x720 Win32 window titled `15. Rasterizer State` opens, clears the swapchain image to this sample's documented color, and presents until closed.
