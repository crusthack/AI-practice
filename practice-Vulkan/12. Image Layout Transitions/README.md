...
## Intent
Practice explicit image layout transitions and pipeline barriers.
...
## Expected Result
A 1280x720 Win32 window titled `12. Image Layout Transitions` opens, clears the swapchain image to this sample's documented color, and presents until closed.
...
```powershell
& "C:\Program Files\Microsoft Visual Studio\18\Community\MSBuild\Current\Bin\MSBuild.exe" ".\12. Image Layout Transitions\12. Image Layout Transitions.vcxproj" /p:Configuration=Debug /p:Platform=x64
```
