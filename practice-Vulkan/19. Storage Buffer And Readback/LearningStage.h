...
// Learning goal: Write GPU data through a storage buffer and read selected results on the CPU.
...
{
    float ClearColor[4] = { 0.07f, 0.12f, 0.06f, 1.0f };
};
