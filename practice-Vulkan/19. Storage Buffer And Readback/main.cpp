...
{
    const wchar_t* className = L"Vulkan19StorageBufferAndReadbackWindowClass";
    ...
    g_hwnd = CreateWindowExW(
        0,
        className,
        L"19. Storage Buffer And Readback",
        WS_OVERLAPPEDWINDOW,
        CW_USEDEFAULT,
        CW_USEDEFAULT,
...
void InitVulkan(VulkanContext& vk)
{
    ...
    appInfo.pApplicationName = "19. Storage Buffer And Readback";
...
int WINAPI wWinMain(HINSTANCE instance, HINSTANCE, PWSTR, int showCommand)
{
    ...
    catch (const std::exception& ex)
    {
        ...
        MessageBoxW(nullptr, message.c_str(), L"19. Storage Buffer And Readback Error", MB_OK | MB_ICONERROR);
        return -1;
    }
}
