...
## Intent
Enable alpha blending and render transparent geometry.
...
## Expected Result
A 1280x720 Win32 window titled `16. Blend State` opens, clears the swapchain image to this sample's documented color, and presents until closed.
