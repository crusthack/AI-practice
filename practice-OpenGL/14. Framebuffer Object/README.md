...
## Intent
Render into an offscreen framebuffer object and sample its color attachment.
...
## Expected Result
A 1280x720 window titled `14. Framebuffer Object` opens, clears to a dark blue-green background, and continues presenting until closed.
...
- `shaders/`: contains `Framebuffer Object.glsl` and shader policy notes.
...
```powershell
& "C:\Program Files\Microsoft Visual Studio\18\Community\MSBuild\Current\Bin\MSBuild.exe" ".\14. Framebuffer Object\14. Framebuffer Object.vcxproj" /p:Configuration=Debug /p:Platform=x64
```
