...
## Intent
Load or procedurally parse mesh data and upload it into GL buffers.
...
## Expected Result
A 1280x720 window titled `19. Model Loading` opens, clears to a dark blue-green background, and continues presenting until closed.
...
- `shaders/`: contains `Model Loading.glsl` and shader policy notes.
...
```powershell
& "C:\Program Files\Microsoft Visual Studio\18\Community\MSBuild\Current\Bin\MSBuild.exe" ".\19. Model Loading\19. Model Loading.vcxproj" /p:Configuration=Debug /p:Platform=x64
```
