# 21. Lighting And Materials

## Intent
Combine normals, material parameters, and lights for Blinn-Phong shading.
...
## Expected Result
A 1280x720 window titled `21. Lighting And Materials` opens, clears to a dark blue-green background, and continues presenting until closed.
...
- `shaders/`: contains `Lighting And Materials.glsl` and shader policy notes.
...
```powershell
& "C:\Program Files\Microsoft Visual Studio\18\Community\MSBuild\Current\Bin\MSBuild.exe" ".\21. Lighting And Materials\21. Lighting And Materials.vcxproj" /p:Configuration=Debug /p:Platform=x64
```
