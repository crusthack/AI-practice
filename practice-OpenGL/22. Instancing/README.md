...
## Intent
Draw many copies of a mesh with per-instance transform or color data.
...
## Expected Result
A 1280x720 window titled `22. Instancing` opens, clears to a dark blue-green background, and continues presenting until closed.
...
- `shaders/`: contains `Instancing.glsl` and shader policy notes.
...
```powershell
& "C:\Program Files\Microsoft Visual Studio\18\Community\MSBuild\Current\Bin\MSBuild.exe" ".\22. Instancing\22. Instancing.vcxproj" /p:Configuration=Debug /p:Platform=x64
```
