...
## Intent
Capture vertex input state with a VAO and separate object setup from draw calls.
...
## Expected Result
A 1280x720 window titled `06. Vertex Array Object` opens, clears to a dark blue-green background, and continues presenting until closed.
...
- `shaders/`: contains `Vertex Array Object.glsl` and shader policy notes.
...
```powershell
& "C:\Program Files\Microsoft Visual Studio\18\Community\MSBuild\Current\Bin\MSBuild.exe" ".\06. Vertex Array Object\06. Vertex Array Object.vcxproj" /p:Configuration=Debug /p:Platform=x64
```
