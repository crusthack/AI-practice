...
// File: main.cpp
//
// Example 4: Index Buffer
// - Extends Example 3 by adding an Index Buffer.
// - Keeps the geometry in clip space so the IA stage is the focus.
//--------------------------------------------------------------------------------------
#include <windows.h>
#include <d3d11.h>
...
HRESULT InitWindow( HINSTANCE hInstance, int nCmdShow )
{
    ...
    g_hWnd = CreateWindow( L"TutorialWindowClass", L"Direct3D 11 Tutorial 4: Index Buffer",
...
void Render()
{
    ...
    // IA reads vertex data by stride/offset and reuses vertices through the index buffer.
    ...
    // Six indices form two triangles while only four unique vertices are stored.
