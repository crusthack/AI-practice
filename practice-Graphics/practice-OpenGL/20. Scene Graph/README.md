...
## Intent
Render multiple objects with transforms, mesh references, and material data.
...
## Expected Result
A 1280x720 window titled `20. Scene Graph` opens, clears to a dark blue-green background, and continues presenting until closed.
...
- `shaders/`: contains `Scene Graph.glsl` and shader policy notes.
...
```powershell
& "C:\Program Files\Microsoft Visual Studio\18\Community\MSBuild\Current\Bin\MSBuild.exe" ".\20. Scene Graph\20. Scene Graph.vcxproj" /p:Configuration=Debug /p:Platform=x64
```
