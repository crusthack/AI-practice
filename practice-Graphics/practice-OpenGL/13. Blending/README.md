...
## Intent
Enable alpha blending and render transparent geometry in controlled order.
...
## Expected Result
A 1280x720 window titled `13. Blending` opens, clears to a dark blue-green background, and continues presenting until closed.
...
- `shaders/`: contains `Blending.glsl` and shader policy notes.
...
```powershell
& "C:\Program Files\Microsoft Visual Studio\18\Community\MSBuild\Current\Bin\MSBuild.exe" ".\13. Blending\13. Blending.vcxproj" /p:Configuration=Debug /p:Platform=x64
```
