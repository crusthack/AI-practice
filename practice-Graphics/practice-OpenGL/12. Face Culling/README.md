...
## Intent
Control front-face winding and cull back or front faces.
...
## Expected Result
A 1280x720 window titled `12. Face Culling` opens, clears to a dark blue-green background, and continues presenting until closed.
...
- `shaders/`: contains `Face Culling.glsl` and shader policy notes.
...
```powershell
& "C:\Program Files\Microsoft Visual Studio\18\Community\MSBuild\Current\Bin\MSBuild.exe" ".\12. Face Culling\12. Face Culling.vcxproj" /p:Configuration=Debug /p:Platform=x64
```
