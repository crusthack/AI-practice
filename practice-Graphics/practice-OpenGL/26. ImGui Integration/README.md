...
## Intent
Attach Dear ImGui as a debug UI overlay for OpenGL runtime parameters.
...
## Expected Result
A 1280x720 window titled `26. ImGui Integration` opens, clears to a dark blue-green background, and continues presenting until closed.
...
- `shaders/`: contains `ImGui Integration.glsl` and shader policy notes.
