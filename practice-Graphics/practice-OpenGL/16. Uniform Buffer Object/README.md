# 16. Uniform Buffer Object

## Intent
Group frame constants in a UBO and bind it across shader programs.
...
## Expected Result
A 1280x720 window titled `16. Uniform Buffer Object` opens, clears to a dark blue-green background, and continues presenting until closed.
...
- `shaders/`: contains `Uniform Buffer Object.glsl` and shader policy notes.
...
```powershell
& "C:\Program Files\Microsoft Visual Studio\18\Community\MSBuild\Current\Bin\MSBuild.exe" ".\16. Uniform Buffer Object\16. Uniform Buffer Object.vcxproj" /p:Configuration=Debug /p:Platform=x64
```
