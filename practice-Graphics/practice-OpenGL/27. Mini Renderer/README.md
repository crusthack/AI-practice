...
## Intent
Combine context setup, shader management, scene data, render passes, and debug UI into a small renderer.
...
## Expected Result
A 1280x720 window titled `27. Mini Renderer` opens, clears to a dark blue-green background, and continues presenting until closed.
...
- `shaders/`: contains `Mini Renderer.glsl` and shader policy notes.
