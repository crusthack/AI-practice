...
{
    const wchar_t* className = L"Vulkan06DescriptorSetsWindowClass";
...
void InitVulkan(VulkanContext& vk)
{
    ...
    appInfo.pApplicationName = "06. Descriptor Sets";
...
int WINAPI wWinMain(HINSTANCE instance, HINSTANCE, PWSTR, int showCommand)
{
    ...
    catch (const std::exception& ex)
    {
        ...
        MessageBoxW(nullptr, message.c_str(), L"06. Descriptor Sets Error", MB_OK | MB_ICONERROR);
        return -1;
    }
}
