...
## Intent
Dispatch a compute shader and synchronize its output.
...
## Expected Result
A 1280x720 Win32 window titled `18. Compute Shader` opens, clears the swapchain image to this sample's documented color, and presents until closed.
