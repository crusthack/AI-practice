...
{
    const wchar_t* className = L"Vulkan05PushConstantsAndUniformsWindowClass";
    ...
    g_hwnd = CreateWindowExW(
        0,
        className,
        L"05. Push Constants And Uniforms",
        WS_OVERLAPPEDWINDOW,
        CW_USEDEFAULT,
        CW_USEDEFAULT,
...
void InitVulkan(VulkanContext& vk)
{
    ...
    appInfo.pApplicationName = "05. Push Constants And Uniforms";
...
int WINAPI wWinMain(HINSTANCE instance, HINSTANCE, PWSTR, int showCommand)
{
    ...
    catch (const std::exception& ex)
    {
        ...
        MessageBoxW(nullptr, message.c_str(), L"05. Push Constants And Uniforms Error", MB_OK | MB_ICONERROR);
        return -1;
    }
}
