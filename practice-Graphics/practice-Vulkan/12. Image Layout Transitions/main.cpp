...
{
    const wchar_t* className = L"Vulkan12ImageLayoutTransitionsWindowClass";
...
void InitVulkan(VulkanContext& vk)
{
    ...
    appInfo.pApplicationName = "12. Image Layout Transitions";
...
int WINAPI wWinMain(HINSTANCE instance, HINSTANCE, PWSTR, int showCommand)
{
    ...
    catch (const std::exception& ex)
    {
        ...
        MessageBoxW(nullptr, message.c_str(), L"12. Image Layout Transitions Error", MB_OK | MB_ICONERROR);
        return -1;
    }
}
