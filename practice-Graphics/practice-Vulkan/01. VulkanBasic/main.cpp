...
{
    const wchar_t* className = L"Vulkan01VulkanBasicWindowClass";
...
void InitVulkan(VulkanContext& vk)
{
    ...
    appInfo.pApplicationName = "01. VulkanBasic";
...
int WINAPI wWinMain(HINSTANCE instance, HINSTANCE, PWSTR, int showCommand)
{
    ...
    catch (const std::exception& ex)
    {
        ...
        MessageBoxW(nullptr, message.c_str(), L"01. VulkanBasic Error", MB_OK | MB_ICONERROR);
        return -1;
    }
}
