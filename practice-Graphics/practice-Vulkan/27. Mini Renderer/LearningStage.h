...
// Learning goal: Combine the lessons into a small Vulkan renderer with passes, descriptors, synchronization, and debug UI.
...
{
    float ClearColor[4] = { 0.10f, 0.08f, 0.11f, 1.0f };
};
