...
// Learning goal: Combine normals, material parameters, and light constants for shaded objects.
...
{
    float ClearColor[4] = { 0.13f, 0.10f, 0.08f, 1.0f };
};
