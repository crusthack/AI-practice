...
## Intent
Apply a full-screen post-processing pass to an offscreen image.
...
- post-process shader
- input attachment or sampled image
- two-pass rendering

## Expected Result
A 1280x720 Win32 window titled `25. Post Processing` opens, clears the swapchain image to this sample's documented color, and presents until closed.
