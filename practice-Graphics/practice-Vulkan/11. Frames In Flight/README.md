...
## Intent
Use per-frame command buffers, semaphores, fences, and uniform buffers.
...
- uniform buffer rotation

## Expected Result
A 1280x720 Win32 window titled `11. Frames In Flight` opens, clears the swapchain image to this sample's documented color, and presents until closed.
...
```powershell
& "C:\Program Files\Microsoft Visual Studio\18\Community\MSBuild\Current\Bin\MSBuild.exe" ".\11. Frames In Flight\11. Frames In Flight.vcxproj" /p:Configuration=Debug /p:Platform=x64
```
