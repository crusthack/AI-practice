...
{
    const wchar_t* className = L"Vulkan14PipelineVariantsWindowClass";
...
void InitVulkan(VulkanContext& vk)
{
    ...
    appInfo.pApplicationName = "14. Pipeline Variants";
...
int WINAPI wWinMain(HINSTANCE instance, HINSTANCE, PWSTR, int showCommand)
{
    ...
    catch (const std::exception& ex)
    {
        ...
        MessageBoxW(nullptr, message.c_str(), L"14. Pipeline Variants Error", MB_OK | MB_ICONERROR);
        return -1;
    }
}
