...
{
    const wchar_t* className = L"Dx1205RootSignatureAndConstantsWindowClass";
    ...
    g_hwnd = CreateWindowExW(
        0,
        className,
        L"05. Root Signature And Constants",
        WS_OVERLAPPEDWINDOW,
        CW_USEDEFAULT,
        CW_USEDEFAULT,
...
int WINAPI wWinMain(HINSTANCE instance, HINSTANCE, PWSTR, int showCommand)
{
    ...
    catch (const std::exception& ex)
    {
        ...
        MessageBoxW(nullptr, message.c_str(), L"05. Root Signature And Constants Error", MB_OK | MB_ICONERROR);
        return -1;
    }
}
