...
{
    const wchar_t* className = L"Dx1225PostProcessingWindowClass";
...
int WINAPI wWinMain(HINSTANCE instance, HINSTANCE, PWSTR, int showCommand)
{
    ...
    catch (const std::exception& ex)
    {
        ...
        MessageBoxW(nullptr, message.c_str(), L"25. Post Processing Error", MB_OK | MB_ICONERROR);
        return -1;
    }
}
