...
{
    const wchar_t* className = L"Dx1211FrameResourcesWindowClass";
...
void Render(Dx12Context& dx, LearningStageState& stage)
{
    ...
    stageContext.FrameIndex = dx.FrameIndex;
...
int WINAPI wWinMain(HINSTANCE instance, HINSTANCE, PWSTR, int showCommand)
{
    ...
    catch (const std::exception& ex)
    {
        ...
        MessageBoxW(nullptr, message.c_str(), L"11. Frame Resources Error", MB_OK | MB_ICONERROR);
        return -1;
    }
}
