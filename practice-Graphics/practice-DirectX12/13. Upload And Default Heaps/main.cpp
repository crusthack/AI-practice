...
{
    const wchar_t* className = L"Dx1213UploadAndDefaultHeapsWindowClass";
...
int WINAPI wWinMain(HINSTANCE instance, HINSTANCE, PWSTR, int showCommand)
{
    ...
    catch (const std::exception& ex)
    {
        ...
        MessageBoxW(nullptr, message.c_str(), L"13. Upload And Default Heaps Error", MB_OK | MB_ICONERROR);
        return -1;
    }
}
