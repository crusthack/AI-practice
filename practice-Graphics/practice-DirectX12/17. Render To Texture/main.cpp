...
{
    const wchar_t* className = L"Dx1217RenderToTextureWindowClass";
...
int WINAPI wWinMain(HINSTANCE instance, HINSTANCE, PWSTR, int showCommand)
{
    ...
    catch (const std::exception& ex)
    {
        ...
        MessageBoxW(nullptr, message.c_str(), L"17. Render To Texture Error", MB_OK | MB_ICONERROR);
        return -1;
    }
}
