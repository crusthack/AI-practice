...
{
    const wchar_t* className = L"Dx1219UAVAndReadbackWindowClass";
...
int WINAPI wWinMain(HINSTANCE instance, HINSTANCE, PWSTR, int showCommand)
{
    ...
    catch (const std::exception& ex)
    {
        ...
        MessageBoxW(nullptr, message.c_str(), L"19. UAV And Readback Error", MB_OK | MB_ICONERROR);
        return -1;
    }
}
