...
{
    const wchar_t* className = L"Dx1209TransformMatricesWindowClass";
...
int WINAPI wWinMain(HINSTANCE instance, HINSTANCE, PWSTR, int showCommand)
{
    ...
    catch (const std::exception& ex)
    {
        ...
        MessageBoxW(nullptr, message.c_str(), L"09. Transform Matrices Error", MB_OK | MB_ICONERROR);
        return -1;
    }
}
