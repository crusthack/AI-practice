...
{
    const wchar_t* className = L"Dx1203VertexBufferUploadWindowClass";
...
int WINAPI wWinMain(HINSTANCE instance, HINSTANCE, PWSTR, int showCommand)
{
    ...
    catch (const std::exception& ex)
    {
        ...
        MessageBoxW(nullptr, message.c_str(), L"03. Vertex Buffer Upload Error", MB_OK | MB_ICONERROR);
        return -1;
    }
}
