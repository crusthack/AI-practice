...
{
    const wchar_t* className = L"Dx1214PipelineStateVariantsWindowClass";
...
int WINAPI wWinMain(HINSTANCE instance, HINSTANCE, PWSTR, int showCommand)
{
    ...
    catch (const std::exception& ex)
    {
        ...
        MessageBoxW(nullptr, message.c_str(), L"14. Pipeline State Variants Error", MB_OK | MB_ICONERROR);
        return -1;
    }
}
