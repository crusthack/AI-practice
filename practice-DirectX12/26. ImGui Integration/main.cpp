...
{
    const wchar_t* className = L"Dx1226ImGuiIntegrationWindowClass";
...
int WINAPI wWinMain(HINSTANCE instance, HINSTANCE, PWSTR, int showCommand)
{
    ...
    catch (const std::exception& ex)
    {
        ...
        MessageBoxW(nullptr, message.c_str(), L"26. ImGui Integration Error", MB_OK | MB_ICONERROR);
        return -1;
    }
}
