...
{
    const wchar_t* className = L"Dx1206DescriptorHeapWindowClass";
...
int WINAPI wWinMain(HINSTANCE instance, HINSTANCE, PWSTR, int showCommand)
{
    ...
    catch (const std::exception& ex)
    {
        ...
        MessageBoxW(nullptr, message.c_str(), L"06. Descriptor Heap Error", MB_OK | MB_ICONERROR);
        return -1;
    }
}
